...
@objc
public class O2SdkSessionStartedListener: NSObject {
    @objc public static var instance: O2SdkSessionStartedListener {
        if _instance == nil {
            _instance = O2SdkSessionStartedListener()
        }
        return _instance!
    }
    ...
    private static var _instance: O2SdkSessionStartedListener?
    ...
    private func tryToSendSessionId() {
        ...
        // else: bridge path is gated until JS O2Sdk.initialize() runs, so that
    ...
    private func sendToJsWithBridge(sessionId: String) {
        ...
        rctBridge.enqueueJSCall(
            O2SdkSessionStartedListener.BRIDGE_MODULE_NAME,
            method: O2SdkSessionStartedListener.BRIDGE_MODULE_METHOD,
            args: [O2SdkSessionStartedListener.BRIDGE_EVENT_NAME, sessionId],
            completion: {}
        )
    }
