...
@objc
public class O2SdkNativeInitialization: NSObject {
    ...
    internal func initialize(sdkConfiguration: O2SdkConfiguration, isCalledFromJs: Bool = true) {
        ...
        if isCalledFromJs {
            ...
            if OpenObserve.isInitialized(instanceName: CoreRegistry.defaultInstanceName) {
                RUMMonitor.shared().currentSessionID { sessionId in
                    ...
                    O2SdkSessionStartedListener.instance.rumSessionListener?(id, false)
                }
            }
        }
    }

    internal func getConfigurationFromJSONFile() -> O2SdkConfiguration? {
    ...
    func enableFeatures(sdkConfiguration: O2SdkConfiguration) {
    ...
    func buildSDKConfiguration(
        configuration: O2SdkConfiguration,
    ...
    func buildRumConfiguration(configuration: O2SdkConfiguration) -> RUM.Configuration {
        ...
        return RUM.Configuration(
            ...
            onSessionStart: O2SdkSessionStartedListener.instance.rumSessionListener,
    ...
    func buildLogsConfiguration(configuration: O2SdkConfiguration) -> Logs.Configuration {
    ...
    func buildTraceConfiguration(configuration: O2SdkConfiguration) -> Trace.Configuration {
    ...
    func setVerbosityLevel(configuration: O2SdkConfiguration) {
