...
@objc
public class O2SdkImplementation: NSObject {
    ...
    public func initialize(
        ...
        let nativeInitialization = O2SdkNativeInitialization()
    ...
    func overrideReactNativeTelemetry(rnConfiguration: O2SdkConfiguration) {
        O2Telemetry.overrideTelemetryConfiguration(
    ...
    func startJSRefreshRateMonitoring(sdkConfiguration: O2SdkConfiguration) {
    ...
    func buildFrameTimeCallback(sdkConfiguration: O2SdkConfiguration) -> ((Double) -> Void)? {
            ...
            sharedQueue.async {
                if shouldRecordFrameTime {
                    let normalizedFrameTimeSeconds =
                        O2SdkImplementation.normalizeFrameTimeForDeviceRefreshRate(frameTime)
