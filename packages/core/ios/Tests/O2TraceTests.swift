...
internal class O2TraceTests: XCTestCase {
    private let mockNativeTracer = MockTracer()
    private var tracer: O2TraceImplementation! // swiftlint:disable:this implicitly_unwrapped_optional
    ...
    override func setUpWithError() throws {
        ...
        tracer = O2TraceImplementation { self.mockNativeTracer }
    ...
    func testItInitializesNativeTracerOnlyOnce() {
        ...
        let tracer = O2TraceImplementation { [unowned self] in
            expectation.fulfill()
