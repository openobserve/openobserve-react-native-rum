...
class O2SdkNativeInitializationTests: XCTestCase {
    var consoleMessage = ""
    ...
    func testReturnsConfigurationWithAllData() {
        ...
        XCTAssertEqual(configuration?.additionalConfiguration?["_o2.source"] as! String, "react-native")
        XCTAssertEqual(configuration?.additionalConfiguration?["_o2.sdk_version"] as! String, SdkVersion)
