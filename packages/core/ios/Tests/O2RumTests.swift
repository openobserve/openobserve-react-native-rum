...
internal class O2RumTests: XCTestCase {
    ...
    private var rum: O2RumImplementation! // swiftlint:disable:this implicitly_unwrapped_optional
    ...
    func testInternalTimestampKeyValue() {
        ...
        XCTAssertEqual(O2RumImplementation.timestampKey, OpenObserveInternal.CrossPlatformAttributes.timestampInMilliseconds)
        XCTAssertEqual(O2RumImplementation.timestampKey, OpenObserveSDKReactNative.CrossPlatformAttributes.timestampInMilliseconds)
    }
    ...
    func testStartView() throws {
        ...
        XCTAssertEqual(lastAttributes[O2RumImplementation.timestampKey] as? Int64, Int64(randomTimestamp))
    }
