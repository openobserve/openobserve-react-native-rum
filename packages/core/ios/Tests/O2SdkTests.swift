...
class O2SdkTests: XCTestCase {
    ...
    func testBuildConfigurationNoUIKitViewsByDefault() {
        let configuration: O2SdkConfiguration = .mockAny()

        let ddConfig = O2SdkNativeInitialization().buildRumConfiguration(
    ...
    func testBuildConfigurationUIKitViewsTrackingDisabled() {
        ...
        let configuration: O2SdkConfiguration = .mockAny(rumConfiguration: rumConfiguration)
    ...
    func testEnableAllFeatures() {
        ...
        O2SdkNativeInitialization().enableFeatures(
    ...
    func testBuildConfigurationDefaultEndpoint() {
        ...
        let ddConfig = O2SdkNativeInitialization().buildSDKConfiguration(
            configuration: configuration
        )
    ...
    func testBuildConfigurationUSEndpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "US")
    ...
    func testBuildConfigurationUS1Endpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "US1")
    ...
    func testBuildConfigurationUS3Endpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "US3")
    ...
    func testBuildConfigurationUS5Endpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "US5")
    ...
    func testBuildConfigurationUS1FEDEndpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "US1_FED")
    ...
    func testBuildConfigurationUS2FEDEndpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "US2_FED")
    ...
    func testBuildConfigurationGOVEndpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "GOV")
    ...
    func testBuildConfigurationEUEndpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "EU")
    ...
    func testBuildConfigurationEU1Endpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "EU1")
    ...
    func testBuildConfigurationAP1Endpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "AP1")
    ...
    func testBuildConfigurationAP2Endpoint() {
        let configuration: O2SdkConfiguration = .mockAny(site: "AP2")
    ...
    func testBuildConfigurationAdditionalConfig() {
        let configuration: O2SdkConfiguration = .mockAny(additionalConfiguration: [
            "foo": "test", "bar": 42,
        ])
    ...
    func testBuildConfigurationWithServiceName() {
        let configuration: O2SdkConfiguration = .mockAny(service: "com.example.app")
    ...
    func testSetUserInfo() throws {
        let bridge = O2SdkImplementation(
            mainDispatchQueue: DispatchQueueMock(),
            jsDispatchQueue: DispatchQueueMock(),
            jsRefreshRateMonitor: JSRefreshRateMonitor(),
            RUMMonitorProvider: { MockRUMMonitor() },
    ...
    func testBuildConfigurationAverageUploadFrequency() {
        let configuration: O2SdkConfiguration = .mockAny(uploadFrequency: "AVERAGE")
    ...
    func testBuildConfigurationFrequentUploadFrequency() {
        let configuration: O2SdkConfiguration = .mockAny(uploadFrequency: "FREQUENT")
    ...
    func testBuildConfigurationRareUploadFrequency() {
        let configuration: O2SdkConfiguration = .mockAny(uploadFrequency: "RARE")
    ...
    func testBuildConfigurationSmallBatchSize() {
        let configuration: O2SdkConfiguration = .mockAny(batchSize: "SMALL")
    ...
    func testBuildConfigurationMediumBatchSize() {
        let configuration: O2SdkConfiguration = .mockAny(batchSize: "MEDIUM")
    ...
    func testBuildConfigurationLargeBatchSize() {
        let configuration: O2SdkConfiguration = .mockAny(batchSize: "LARGE")
    ...
    func testBuildConfigurationLowBatchProcessingLevel() {
        let configuration: O2SdkConfiguration = .mockAny(batchProcessingLevel: "LOW")
    ...
    func testBuildConfigurationMediumBatchProcessingLevel() {
        let configuration: O2SdkConfiguration = .mockAny(batchProcessingLevel: "MEDIUM")
    ...
    func testBuildConfigurationHighBatchProcessingLevel() {
        let configuration: O2SdkConfiguration = .mockAny(batchProcessingLevel: "HIGH")
    ...
    func testFrameTimeNormalizationUtilityFunction() {
        ...
        var frameTimeSeconds = O2SdkImplementation.normalizeFrameTimeForDeviceRefreshRate(
        ...
        frameTimeSeconds = O2SdkImplementation.normalizeFrameTimeForDeviceRefreshRate(
    ...
    func testBackgroundTrackingUndefined() {
        ...
        let configuration: O2SdkConfiguration = O2SdkConfiguration.mockAny(
            rumConfiguration: rumConfiguration)
    ...
    func testConfigurationTelemetryOverride() throws {
        ...
        O2SdkImplementation().overrideReactNativeTelemetry(rnConfiguration: configuration)
