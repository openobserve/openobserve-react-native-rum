...
Pod::Spec.new do |s|
  ...
  s.dependency 'OpenObserveCore', '0.1.0-alpha.2'
  s.dependency 'OpenObserveLogs', '0.1.0-alpha.2'
  s.dependency 'OpenObserveTrace', '0.1.0-alpha.2'
  s.dependency 'OpenObserveRUM', '0.1.0-alpha.2'
  s.dependency 'OpenObserveCrashReporting', '0.1.0-alpha.2'
  s.dependency 'OpenObserveFlags', '0.1.0-alpha.2'

  # OpenObserveWebViewTracking is not available for tvOS
  s.ios.dependency 'OpenObserveWebViewTracking', '0.1.0-alpha.2'
