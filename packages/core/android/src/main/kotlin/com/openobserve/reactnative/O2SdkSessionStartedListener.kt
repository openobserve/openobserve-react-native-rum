...
import com.openobserve.android.rum.RumSessionListener
...
internal class O2SdkSessionStartedListener private constructor() : RumSessionListener {
    companion object {
        // JS-side callable module registered via BatchedBridge.registerCallableModule.
        private const val BRIDGE_MODULE_NAME = "OpenObserveInternalReactBridge"
        private const val BRIDGE_MODULE_METHOD = "__datadogOnMessageReceived"

        private var instance: O2SdkSessionStartedListener? = null
        ...
        fun getInstance(): O2SdkSessionStartedListener {
            if (instance == null) {
                instance = O2SdkSessionStartedListener()
            }
            return instance!!
        }
    ...
    //   - O2Sdk#onHostResume (both architectures) via the lifecycle listener
    //   - O2SdkImplementation#initialize (new-arch race fix — the TurboModule is lazy-
    ...
    // SDK was already running. At this point OpenObserveInternalReactBridge is guaranteed to
