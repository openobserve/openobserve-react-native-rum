 ...
 *
 * @param additionalConfiguration Additional configuration parameters forwarded to the native OpenObserve SDK.
 * @param clientToken A valid OpenObserve client token.
 * @param env The application’s environment, for example: prod, pre-prod, staging, etc.
 * @param site The OpenObserve site of your organization (can be 'US', 'EU' or 'GOV', default is 'US').
 ...
 * @param configurationForTelemetry Additional configuration data for OpenObserve telemetry.
 */
data class O2SdkConfiguration(
 ...
 * @param customEndpoint Custom RUM intake endpoint used to override the default OpenObserve intake.
 */
 ...
 * @param customEndpoint Custom Logs intake endpoint used to override the default OpenObserve intake.
 */
...
/**
 * A configuration object for OpenObserve Traces (APM) features.
 *
 * @param customEndpoint Custom Trace intake endpoint used to override the default OpenObserve intake.
 */
...
/**
 * Additional configuration data for OpenObserve telemetry.
