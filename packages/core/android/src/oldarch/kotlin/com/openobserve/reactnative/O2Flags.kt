...
class O2Flags(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {

    private val implementation = O2FlagsImplementation()

    override fun getName(): String = O2FlagsImplementation.NAME
