...
import com.openobserve.android.trace.api.span.OpenObserveSpanBuilder
import com.openobserve.android.trace.api.span.OpenObserveSpanContext
import com.openobserve.android.trace.api.trace.OpenObserveTraceId
...
internal class O2TraceTest {

    lateinit var testedTrace: O2TraceImplementation

    @Mock
    lateinit var mockTracer: OpenObserveTracer

    @Mock
    lateinit var mockSpanBuilder: OpenObserveSpanBuilder

    @Mock
    lateinit var mockSpanContext: OpenObserveSpanContext

    @Mock
    lateinit var mockSpan: OpenObserveSpan

    @Mock
    lateinit var mockScope: OpenObserveScope
    ...
    @Mock
    lateinit var fakeTraceId: OpenObserveTraceId
    ...
    fun `set up`() {
        ...
        testedTrace = O2TraceImplementation(tracerProvider = { mockTracer })
    }
