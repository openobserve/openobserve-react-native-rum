...
import com.openobserve.android.rum.RumPerformanceMetric
...
import com.openobserve.android.trace.TracingHeaderType
import com.openobserve.tools.unit.GenericAssert.Companion.assertThat
import com.openobserve.tools.unit.MockRumMonitor
import com.openobserve.tools.unit.TestJsThreadExecutor
import com.openobserve.tools.unit.TestUiThreadExecutor
import com.openobserve.tools.unit.forge.BaseConfigurator
import com.openobserve.tools.unit.setStaticValue
import com.openobserve.tools.unit.toReadableArray
import com.openobserve.tools.unit.toReadableJavaOnlyMap
import com.openobserve.tools.unit.toReadableMap
...
internal class O2SdkTest {
    lateinit var testedBridgeSdk: O2SdkImplementation
    ...
    @Mock
    lateinit var mockOpenObserve: OpenObserveWrapper

    @Mock
    lateinit var mockDdTelemetry: O2Telemetry

    @Forgery
    lateinit var fakeConfiguration: O2SdkConfiguration
    ...
    fun `set up`() {
        ...
        whenever(mockOpenObserve.getRumMonitor()) doReturn mockRumMonitor
        ...
        testedBridgeSdk = O2SdkImplementation(
            mockReactContext,
            mockOpenObserve,
            mockDdTelemetry,
        ...
        OpenObserveSDKWrapperStorage.onInitializedListeners.clear()
    }
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {nativeCrashReportEnabled=true}`() {
        ...
        try {
            ...
            // Then
            inOrder(mockOpenObserve) {
                verify(mockOpenObserve).initialize(
                    same(mockContext),
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {needsClearTextHttp=true}`() {
        ...
        val additionalConfig = (
            ...
            ).also { it[O2SdkImplementation.DD_NEEDS_CLEAR_TEXT_HTTP] = true }
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", OpenObserveSite.US1)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", OpenObserveSite.US3)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", OpenObserveSite.US5)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", OpenObserveSite.US1_FED)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", OpenObserveSite.US2_FED)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", OpenObserveSite.EU1)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", OpenObserveSite.AP1)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", OpenObserveSite.AP2)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {no view tracking}`(
        @Forgery configuration: O2SdkConfiguration
    ) {
        // Given
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {sdk verbosity}`(
        ...
        // Then
        verify(mockOpenObserve).setVerbosity(verbosity)
    }
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {invalid sdk verbosity}`(
        ...
        // Then
        verify(mockOpenObserve, never()).setVerbosity(any())
    }
                ...
                .hasField("featureConfiguration") { rumConfig ->
                    rumConfig.hasField("longTaskTrackingStrategy") { longTaskTrackingStrategy ->
                        longTaskTrackingStrategy
                            .isInstanceOf(
                                "com.openobserve.android.rum.internal.instrumentation." +
    ...
    fun `𝕄 set version 𝕎 initialize() {versionSuffix}`(
        ...
        val bridgeConfiguration = configuration.copy(
            additionalConfiguration = mapOf(
                O2SdkImplementation.DD_VERSION_SUFFIX to versionSuffix
            )
        )
        val sdkConfigCaptor = argumentCaptor<Configuration>()
        val rumConfigCaptor = argumentCaptor<RumConfiguration>()
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasFieldEqualTo(
                    ...
                    mapOf(
                        O2SdkImplementation.DD_VERSION_SUFFIX to versionSuffix,
                        O2SdkImplementation.DD_VERSION to (
    ...
    fun `𝕄 clear user info 𝕎 clearUserInfo()`() {
        ...
        // Then
        argumentCaptor<Map<String, Any?>> {
            verify(mockOpenObserve).clearUserInfo()
        }
    }
    ...
    fun `M set Rum attribute W addAttribute`(
        ...
        // Then
        verify(mockOpenObserve).addRumGlobalAttribute(key, value)
    }
    ...
    fun `M remove Rum attribute W removeAttribute`(
        ...
        // Then
        verify(mockOpenObserve).removeRumGlobalAttribute(key)
    }
    ...
    fun `𝕄 set RUM attributes 𝕎 addAttributes`(
        ...
        // Then
        verify(mockOpenObserve).addRumGlobalAttributes(customAttributes)
    }
    ...
    fun `𝕄 remove RUM attributes 𝕎 removeAttributes`(
        ...
        // Then
        verify(mockOpenObserve).removeRumGlobalAttributes(customAttributes.keys.toTypedArray())
    }
    ...
    fun `𝕄 call setTrackingConsent 𝕎 setTrackingConsent ()`(forge: Forge) {
        ...
        // Then
        verify(mockOpenObserve).setTrackingConsent(consent.asTrackingConsent())
    }
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {synthethics attributes}`() {
        ...
        fakeConfiguration = fakeConfiguration.copy(site = null, rumConfiguration = rumConfiguration)
        O2SdkSynthetics.testId = "unit-test-test-id"
        O2SdkSynthetics.resultId = "unit-test-result-id"
