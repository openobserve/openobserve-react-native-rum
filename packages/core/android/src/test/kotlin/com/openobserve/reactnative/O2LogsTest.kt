...
internal class O2LogsTest {

    lateinit var testedLogs: O2LogsImplementation
    ...
    fun `set up`(forge: Forge) {
        testedLogs = O2LogsImplementation(datadog = mockOpenObserve, logger = { mockLogger })
    ...
    fun `M recreate logger W SDK is initialized`() {
        ...
        val testedLogs = O2LogsImplementation(
            datadog = mockOpenObserve,
        ...
        // When
        OpenObserveSDKWrapperStorage.notifyOnInitializedListeners(mock())
