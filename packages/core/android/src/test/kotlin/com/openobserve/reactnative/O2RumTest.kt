...
import com.openobserve.android.rum.RumAttributes
...
internal class O2RumTest {
    ...
    fun `set up`(forge: Forge) {
        ...
        testedDdRum = O2RumImplementation(mockOpenObserve)
    }
