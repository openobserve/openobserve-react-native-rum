...
class O2Sdk(
    ...
    datadogWrapper: OpenObserveWrapper = OpenObserveSDKWrapper(),
    ddTelemetry: O2Telemetry = O2Telemetry()
) : NativeDdSdkSpec(reactContext) {

    private val implementation = O2SdkImplementation(reactContext, datadog = datadogWrapper, ddTelemetry)

    override fun getName(): String = O2SdkImplementation.NAME
        ...
        reactContext.addLifecycleEventListener(object : LifecycleEventListener {
            override fun onHostResume() {
                ...
                if (currentActivity != null) {
                    ...
                    O2SdkSynthetics.testId = extras?.getString("_o2.synthetics.test_id")
                    O2SdkSynthetics.resultId = extras?.getString("_o2.synthetics.result_id")
                }
