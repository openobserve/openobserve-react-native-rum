...
class BabelInteractionTracking {
    ...
    private ddRum: typeof O2Rum | null = null;

    isInitialized: boolean = false;

    getInstance() {
        return O2BabelInteractionTracking;
    }

    attachRumInstance(ddRum: typeof O2Rum) {
        this.ddRum = ddRum;
...
export const O2BabelInteractionTracking = getGlobalInstance(
