...
import { OpenObserveTracingIdentifier } from './OpenObserveTracingIdentifier';
 ...
 * for RUM Resources.
 */
export class OpenObserveTracingContext {
    ...
    readonly traceId?: OpenObserveTracingIdentifier;
    readonly spanId?: OpenObserveTracingIdentifier;
    ...
    constructor(
        ...
        this.traceId = traceId
            ? new OpenObserveTracingIdentifier(traceId)
            : undefined;
        this.spanId = spanId ? new OpenObserveTracingIdentifier(spanId) : undefined;
    }
