...
import type {
    OpenObserveEventEmitterCallback,
    OpenObserveEventEmitter
} from './OpenObserveEventEmitter';

export class OpenObserveBatchedBridgeEventEmitter implements OpenObserveEventEmitter {
    private listeners: Record<string, OpenObserveEventEmitterCallback>;
    ...
    initialize(): boolean {
        try {
            ...
            batchedBridge.registerCallableModule(
                'OpenObserveInternalReactBridge',
                this
            );
    ...
    addListener(
        eventName: string,
        callback: OpenObserveEventEmitterCallback
    ): void {
