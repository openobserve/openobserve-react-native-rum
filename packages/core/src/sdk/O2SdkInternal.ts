...
import type { O2NativeSdkType } from '../nativeModulesTypes';

import type { AttributeEncoder } from './AttributesEncoding/types';

// eslint-disable-next-line global-require, @typescript-eslint/no-var-requires
const NativeDdSdk: O2NativeSdkType = require('../specs/NativeDdSdk').default;

export type O2SdkType = {
...
export class O2SdkWrapper implements O2NativeSdkType {
