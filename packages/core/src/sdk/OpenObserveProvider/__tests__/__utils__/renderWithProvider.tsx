...
export const getDefaultConfiguration = () => {
    const defaultConfiguration = new OpenObserveProviderConfiguration(
        'fakeToken',
        'fakeEnv'
    );
...
export const renderWithProvider = (params?: {
    ...
    const rerenderWithRandomConfig = () => {
        const randomConfiguration = new OpenObserveProviderConfiguration(
        ...
        result.rerender(
            <OpenObserveProvider configuration={randomConfiguration}>
                {AppComponent}
            </OpenObserveProvider>
        );
    };
