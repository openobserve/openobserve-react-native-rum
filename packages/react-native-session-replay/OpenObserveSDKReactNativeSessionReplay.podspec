...
Pod::Spec.new do |s|
  s.name         = "OpenObserveSDKReactNativeSessionReplay"
  ...
  s.dependency 'OpenObserveSessionReplay', '0.1.0-alpha.3'
  ...
  if ENV['RCT_NEW_ARCH_ENABLED'] == '1' then
    ...
    if respond_to?(:install_modules_dependencies, true)
      ...
      Pod::UI.warn "Using OpenObserve React Native Session Replay with new architecture on RN < 0.71 is discouraged and not officially supported."
    end
  else
    s.pod_target_xcconfig = xcconfig
  end
