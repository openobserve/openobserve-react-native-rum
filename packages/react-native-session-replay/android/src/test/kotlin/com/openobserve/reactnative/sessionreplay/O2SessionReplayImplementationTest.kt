...
import com.openobserve.android.sessionreplay.SessionReplayPrivacy
...
internal class O2SessionReplayImplementationTest {

    lateinit var testedSessionReplay: O2SessionReplayImplementation
    ...
    fun `set up`() {
        ...
        testedSessionReplay =
            O2SessionReplayImplementation(mockReactContext) { mockSessionReplay }
    }
