 ...
 */
class O2SessionReplay(
    reactContext: ReactApplicationContext
) : ReactContextBaseJavaModule(reactContext) {

    private val implementation = O2SessionReplayImplementation(reactContext)

    override fun getName(): String = O2SessionReplayImplementation.NAME
