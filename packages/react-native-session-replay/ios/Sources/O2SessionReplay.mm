...
#endif
#import "O2SessionReplay.h"


@implementation O2SessionReplay
...
- (O2SessionReplayImplementation*)ddSessionReplayImplementation
{
    if (_ddSessionReplayImplementation == nil) {
        _ddSessionReplayImplementation = [[O2SessionReplayImplementation alloc] initWithBridge:_bridge];
    }
