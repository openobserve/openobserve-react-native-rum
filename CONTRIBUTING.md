...
# Run a command for the particular workspace (ex. @openobserve/mobile-react-native)
yarn workspace @openobserve/mobile-react-native <command>
```
...
To share your request, you can open an [issue](https://github.com/openobserve/openobserve-react-native-rum/issues/new) 
...
[submit as a pull request](https://github.com/openobserve/openobserve-react-native-rum/pull/new/master).
...
1. **Fork the repository** from https://github.com/openobserve/openobserve-react-native-rum ;
...
5. **Submit the pull request** from your fork back to this 
    [repository](https://github.com/openobserve/openobserve-react-native-rum) .
